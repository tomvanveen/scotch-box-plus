...
class __TwigTemplate_0126c082af420393b26df2a00d87d2860b2d37933e767fde30538f2e4ea52c2f extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 23
        yield "    ";
        if ((1 === CoreExtension::compare(($context["num_favorite_tables"] ?? null), 0))) {
            // line 24
...
($context["drop_message"] ?? null)]), "");
    ...
    ";
        // line 92
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["current_table"] ?? null), "TABLE_ROWS", [], "array", true, true, false, 92) && ((0 !== CoreExtension::compare((($__internal_compile_4 =         // line 93
...
($context["current_table"] ?? null)) && is_array($__internal_compile_7) || $__internal_compile_7 instanceof ArrayAccess ? ($__internal_compile_7["TABLE_NAME"] ?? null) : null)]);
        ...
        ";
            // line 117
            if ( !(1 === CoreExtension::compare(($context["properties_num_columns"] ?? null), 1))) {
                // line 118
...
yield _gettext("View");
            ...
            ";
                // line 125
                if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["collation"] ?? null)), 0))) {
                    // line 126
                    yield "                <td class=\"text-nowrap\">
                    ";
                    // line 127
        ...
        ";
            ...
            if (($context["show_charset"] ?? null)) {
                ...
                ";
                // line 145
                if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["charset"] ?? null)), 0))) {
                    // line 146
                    yield "                    ";
        ...
        ";
            ...
            if (($context["show_comment"] ?? null)) {
                ...
                ";
                // line 154
                if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["comment"] ?? null)), ($context["limit_chars"] ?? null)))) {
                    // line 155
                    yield "                    <abbr title=\"";
...
";
    ...
    {
        return new Source("", "database/structure/structure_table_row.twig", "/var/www/public/phpmyadmin/templates/database/structure/structure_table_row.twig");
    }
}
