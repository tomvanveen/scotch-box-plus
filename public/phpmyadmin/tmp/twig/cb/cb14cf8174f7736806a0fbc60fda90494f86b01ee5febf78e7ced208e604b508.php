...
class __TwigTemplate_dab93453b7a77cf2524b6498be77fa623e132e9512eb383c4ec56b729164cefb extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Replication");
    ...
    ";
        ...
        // line 14
        yield "    ";
        if ((0 === CoreExtension::compare(($context["num_favorite_tables"] ?? null), 0))) {
            // line 15
            yield "        ";
...
";
    ...
    {
        return new Source("", "database/structure/body_for_table_summary.twig", "/var/www/public/phpmyadmin/templates/database/structure/body_for_table_summary.twig");
    }
}
