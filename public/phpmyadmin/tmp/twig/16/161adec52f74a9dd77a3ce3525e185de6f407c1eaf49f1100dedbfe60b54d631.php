...
class __TwigTemplate_d953833256ab1ed1010f09e3a67c8fa93f649c6aabac12a1279d8ee3b5f85fa7 extends Template
{
    private $source;
    private $macros = [];
...
($context["column"] ?? null), "True_Type", [], "any", false, false, false, 16)) || CoreExtension::inFilter("set", CoreExtension::getAttribute($this->env, $this->source, ($context["column"] ?? null), "True_Type", [], "any", false, false, false, 16)))) {
  ...
  <td>
    ";
        // line 28
        if (((0 === CoreExtension::compare(Twig\Extension\CoreExtension::upper($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, ($context["column"] ?? null), "Null", [], "any", false, false, false, 28)), "YES")) &&  !($context["read_only"] ?? null))) {
            // line 29
...
") : (""));
        ...
        ";
                // line 62
                if ((CoreExtension::inFilter("text", CoreExtension::getAttribute($this->env, $this->source, ($context["column"] ?? null), "pma_type", [], "any", false, false, false, 62)) && (1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["special_chars"] ?? null)), 32000)))) {
                    // line 63
                    yield "          </td>
          <td>
          ";
yield _gettext("Because of its length,<br> this column might not be editable.");
                ...
                // line 67
                yield "      ";
            } elseif ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["column"] ?? null), "pma_type", [], "any", false, false, false, 67), "enum"))) {
                // line 68
                yield "        ";
                yield ($context["backup_field"] ?? null);
                yield "
        ...
        ";
                // line 70
                if ((1 === CoreExtension::compare(Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, ($context["column"] ?? null), "Type", [], "any", false, false, false, 70)), 20))) {
                    // line 71
            ...
            ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["enum_value"]) {
                        ...
                        yield "\"";
                        yield (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["enum_value"], "plain", [], "any", false, false, false, 74), ($context["enum_selected_value"] ?? null)))) ? (" selected") : (""));
                        yield ">";
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["enum_value"], "plain", [], "any", false, false, false, 74), "html", null, true);
                        yield "</option>
            ";
        ...
        ";
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["enum_value"]) {
                        ...
                        yield "')\"";
                        yield (((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, $context["enum_value"], "plain", [], "any", false, false, false, 79), ($context["enum_selected_value"] ?? null)))) ? (" checked") : (""));
                        yield ">
            <label for=\"field_";
                        // line 80
                        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["id_index"] ?? null), "html", null, true);
          ...
          ";
                ...
                // line 83
                yield "      ";
            } elseif ((0 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["column"] ?? null), "pma_type", [], "any", false, false, false, 83), "set"))) {
                // line 84
                yield "        ";
                yield ($context["backup_field"] ?? null);
                yield "
...
($context["column"] ?? null), "is_blob", [], "any", false, false, false, 97) || (1 === CoreExtension::compare(CoreExtension::getAttribute($this->env, $this->source, ($context["column"] ?? null), "len", [], "any", false, false, false, 97), ($context["limit_chars"] ?? null))))) {
                    // line 98
                    yield "          ";
                    yield ($context["backup_field"] ?? null);
                    yield "
...
";
    ...
    {
        return new Source("", "table/insert/column_row.twig", "/var/www/public/phpmyadmin/templates/table/insert/column_row.twig");
    }
}
