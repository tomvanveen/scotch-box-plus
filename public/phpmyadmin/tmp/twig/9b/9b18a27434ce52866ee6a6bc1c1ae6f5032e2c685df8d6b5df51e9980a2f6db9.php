...
class __TwigTemplate_f27d6c6dff545dd8e6cca5ee85e81929ed35acd877c3b0ffb07d9ae1724130c4 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Check all");
    ...
    ";
        // line 5
        if ((0 !== CoreExtension::compare(($context["overhead_check"] ?? null), ""))) {
            // line 6
...
";
    ...
    {
        return new Source("", "database/structure/check_all_tables.twig", "/var/www/public/phpmyadmin/templates/database/structure/check_all_tables.twig");
    }
}
